...
public interface CharacterService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "requestString", targetNamespace = "http://medianews.vn/", className = "vn.medianews.RequestString")
    @ResponseWrapper(localName = "requestStringResponse", targetNamespace = "http://medianews.vn/", className = "vn.medianews.RequestStringResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "submitCharacterStringArray", targetNamespace = "http://medianews.vn/", className = "vn.medianews.SubmitCharacterStringArray")
    @ResponseWrapper(localName = "submitCharacterStringArrayResponse", targetNamespace = "http://medianews.vn/", className = "vn.medianews.SubmitCharacterStringArrayResponse")
