...
public interface DataService {
    ...
    @RequestWrapper(localName = "getData", targetNamespace = "http://medianews.vn/", className = "vn.medianews.GetData")
    @ResponseWrapper(localName = "getDataResponse", targetNamespace = "http://medianews.vn/", className = "vn.medianews.GetDataResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "submitDataStringArray", targetNamespace = "http://medianews.vn/", className = "vn.medianews.SubmitDataStringArray")
    @ResponseWrapper(localName = "submitDataStringArrayResponse", targetNamespace = "http://medianews.vn/", className = "vn.medianews.SubmitDataStringArrayResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "submitDataIntMatrix", targetNamespace = "http://medianews.vn/", className = "vn.medianews.SubmitDataIntMatrix")
    @ResponseWrapper(localName = "submitDataIntMatrixResponse", targetNamespace = "http://medianews.vn/", className = "vn.medianews.SubmitDataIntMatrixResponse")
    @Action(input = "http://medianews.vn/DataService/submitDataIntMatrixRequest", output = "http://medianews.vn/DataService/submitDataIntMatrixResponse")
    public void submitDataIntMatrix(
        @WebParam(name = "studentCode", targetNamespace = "")
        String studentCode,
        @WebParam(name = "qCode", targetNamespace = "")
        String qCode,
